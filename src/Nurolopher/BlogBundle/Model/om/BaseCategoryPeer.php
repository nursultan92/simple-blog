...
use Nurolopher\BlogBundle\Model\map\CategoryTableMap;
...
abstract class BaseCategoryPeer
{
    ...
    const OM_CLASS = 'Nurolopher\\BlogBundle\\Model\\Category';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Nurolopher\\BlogBundle\\Model\\map\\CategoryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Nurolopher\BlogBundle\Model\map\CategoryTableMap());
      }
    }
