...
use Nurolopher\BlogBundle\Model\map\CommentTableMap;
...
abstract class BaseCommentPeer
{
    ...
    const OM_CLASS = 'Nurolopher\\BlogBundle\\Model\\Comment';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Nurolopher\\BlogBundle\\Model\\map\\CommentTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Body', 'PostId', 'UserId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'body', 'postId', 'userId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::BODY, CommentPeer::POST_ID, CommentPeer::USER_ID, CommentPeer::CREATED_AT, CommentPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'BODY', 'POST_ID', 'USER_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'body', 'post_id', 'user_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Body' => 1, 'PostId' => 2, 'UserId' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'body' => 1, 'postId' => 2, 'userId' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::BODY => 1, CommentPeer::POST_ID => 2, CommentPeer::USER_ID => 3, CommentPeer::CREATED_AT => 4, CommentPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'BODY' => 1, 'POST_ID' => 2, 'USER_ID' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'body' => 1, 'post_id' => 2, 'user_id' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCommentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Nurolopher\BlogBundle\Model\map\CommentTableMap());
      }
    }
