...
use Nurolopher\BlogBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Nurolopher\\BlogBundle\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Nurolopher\\BlogBundle\\Model\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Nurolopher\BlogBundle\Model\map\UserTableMap());
      }
    }
