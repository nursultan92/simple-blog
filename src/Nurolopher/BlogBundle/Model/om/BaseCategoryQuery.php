 ...
 *
 * @method CategoryQuery leftJoinPostCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the PostCategory relation
 * @method CategoryQuery rightJoinPostCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PostCategory relation
 * @method CategoryQuery innerJoinPostCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the PostCategory relation
 *
...
abstract class BaseCategoryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Nurolopher\\BlogBundle\\Model\\Category';
        }
    ...
    public function filterByPostCategory($postCategory, $comparison = null)
    {
        if ($postCategory instanceof PostCategory) {
            return $this
                ->addUsingAlias(CategoryPeer::ID, $postCategory->getCategoryId(), $comparison);
