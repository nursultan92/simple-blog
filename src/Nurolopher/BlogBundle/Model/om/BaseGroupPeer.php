...
use Nurolopher\BlogBundle\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const TM_CLASS = 'Nurolopher\\BlogBundle\\Model\\map\\GroupTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Nurolopher\BlogBundle\Model\map\GroupTableMap());
      }
    }
